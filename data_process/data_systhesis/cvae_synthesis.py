...
class CVAESynthesisData(ProcessedData):
    ...
    def process(self):
        ...
        parser.add_argument("-d", "--dataset", type=str, help="The dataset name")
        parser.add_argument("-p", "--project", type=str, help="The project name")
        parser.add_argument("-i", "--iteration", type=int, help="The iteration number")
        parser.add_argument("-m", "--metrics", type=str, help="Metrics to use, separated by commas")
        parser.add_argument("-e", "--encoder", type=str, help="The encoder type")
        parser.add_argument("-cp", "--compress", type=float, help="Compression ratio")
        parser.add_argument("-ep", "--expand", type=float, help="Expansion ratio")
